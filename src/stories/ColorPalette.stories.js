...
export default {
  ...
  parameters: {
    docs: {
      description: {
        component: 'Displays the primary color and its shades, along with neutral colors used in our brand.',
      },
    },
  },
  argTypes: {
    palette: {
      control: 'object',
      description: 'Defines the color palette including primary color, its shades, and neutral colors.',
    },
  },
};
