...
const sampleSlides = [
    {
        ...
        bottleImage:
        'https://fnac.sa/cdn/shop/files/Closca_Bottle_Wave_Sahara_600ml_Close.png?v=1703675684',
      ...
      },
  {
    ...
    subtitle: '€39.90',
    contentTitle:
      "The Earth's area affected by desertification is approximately 11 times the size of India.",
    contentSubtitle:
    ...
    shopNowLink: '#',
    bottleBgImage:
      'https://images.unsplash.com/photo-1613109526778-27605f1f27d2?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=2340&q=80',
    bottleImage:
      'https://fnac.sa/cdn/shop/files/Closca_Bottle_Wave_Sahara_600ml_Close.png?v=1703675684',
  ...
  },
  {
    ...
    contentSubtitle:
      'The effects of melting glaciers are biodiversity loss, the rising of sea levels, and freshwater shortages.',
    shopNowLink: '#',
    bottleBgImage:
...
export const Default = (args) => <PortfolioMainSlider {...args} />;
