...
import CookbookCard from '../../components/CookBook/CookbookCard/CookbookCard'; // Adjust the path to the actual location of your component

export default {
  title: 'CookBook/Atoms/Cards/CookbookCard',
