...
export const GithubIcon = ({ className }) => (
  <svg className={className} viewBox="0 0 20 20" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" fill="#000000">
    <g id="SVGRepo_bgCarrier" strokeWidth="0"></g>
    <g id="SVGRepo_tracerCarrier" strokeLinecap="round" strokeLinejoin="round"></g>
    <g id="SVGRepo_iconCarrier">
...
export const SearchIcon = ({ className }) => (
  <svg className={className} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 20 20" strokeWidth="1.5" stroke="currentColor">
    <path strokeLinecap="round" strokeLinejoin="round" d="M16.72 17.78a.75.75 0 1 0 1.06-1.06l-1.06 1.06ZM9 14.5A5.5 5.5 0 0 1 3.5 9H2a7 7 0 0 0 7 7v-1.5ZM3.5 9A5.5 5.5 0 0 1 9 3.5V2a7 7 0 0 0-7 7h1.5ZM9 3.5A5.5 5.5 0 0 1 14.5 9H16a7 7 0 0 0-7-7v1.5Zm3.89 10.45 3.83 3.83 1.06-1.06-3.83-3.83-1.06 1.06ZM14.5 9a5.48 5.48 0 0 1-1.61 3.89l1.06 1.06A6.98 6.98 0 0 0 16 9h-1.5Zm-1.61 3.89A5.48 5.48 0 0 1 9 14.5V16a6.98 6.98 0 0 0 4.95-2.05l-1.06-1.06Z" />
  </svg>
);
export const WebsiteIcon = ({ className }) => (
  <svg className={className} fill="#000000" viewBox="0 0 512 512" version="1.1" xmlSpace="preserve" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" stroke="#000000" strokeWidth="0.00512">
    <g id="SVGRepo_bgCarrier" strokeWidth="0"></g>
    <g id="SVGRepo_tracerCarrier" strokeLinecap="round" strokeLinejoin="round"></g>
    <g id="SVGRepo_iconCarrier">
...
export const IdeaIcon = ({ className }) => (
  ...
  >
    ...
    <g id="SVGRepo_tracerCarrier" strokeLinecap="round" strokeLinejoin="round"></g>
    <g id="SVGRepo_iconCarrier">
      <path d="M457.45,0c-154.7,0-280.1,125.4-280.1,280.1c0,176.4,167.6,378.4,167.6,378.4h234.9c0,0,157.801-202,157.801-378.4 C737.549,125.4,612.15,0,457.45,0z M540.15,472.399c-14.102,14.801-33.102,25-54.9,29.7v7.5c0,13-10.6,23.601-23.6,23.601H451.45 c-13,0-23.6-10.601-23.6-23.601v-8c-11.5-2.5-22.301-6.3-32.301-11.5c-13.3-6.8-24.8-17.899-34.3-32.899 c-6.3-9.9-10.899-21.5-13.7-34.4c-1.399-6.3-0.1-12.6,3.5-18c3.601-5.3,9.301-9,15.601-10.1l10.2-1.801 c1.3-0.199,2.699-0.399,4.1-0.399c10.8,0,20.2,7.3,22.8,17.8c2.7,10.6,6.3,18.8,10.7,24.5c9.9,12.7,26.4,20.3,44,20.3 c3,0,6-0.2,8.9-0.7c12.6-1.899,23.699-7.8,31.5-16.6c8.199-9.3,12.4-21.2,12.4-35.2c0-11.7-2.801-21.1-8.301-27.899 c-10.6-13-29.299-18.601-46.2-22.5c-22.3-5.101-42.5-10.2-62.899-21.601c-13.601-7.6-24.101-18.2-31.5-31.6 c-7.301-13.3-10.9-28.4-10.9-45.1c0-29.6,10.7-54,31.8-72.5c11.601-10.1,27-17.4,44.7-21.2v-11.5c0-13,10.6-23.6,23.6-23.6h10.201 c13,0,23.6,10.6,23.6,23.6v11.8c16.4,3.7,30.699,10.4,41.699,19.5c12.602,10.5,21.9,23.9,27.602,39.8 c2.398,6.6,1.699,13.8-1.9,19.9s-9.801,10.2-16.801,11.3l-9.9,1.5c-1.199,0.2-2.299,0.3-3.5,0.3c-10.1,0-19.1-6.4-22.299-16 c-2.201-6.4-5.1-11.7-8.6-15.6c-8.102-9.1-21-14.3-35.3-14.3c-15.4,0-29.801,5.9-38.601,15.8c-7.1,8-10.6,17.3-10.6,28.3 c0,10.9,3,20,8.899,27.1c12.801,15.4,34.7,19.8,55.9,24.1c13.1,2.6,26.6,5.4,38.6,10.6c12.801,5.6,23.5,12.7,31.701,20.9 c8.299,8.3,14.799,18.3,19.199,29.7c4.4,11.301,6.6,23.601,6.6,36.7C567.85,428.8,558.549,453.1,540.15,472.399z"></path>
      <rect x="339.45" y="691.6" width="235.9" height="60.9"></rect>
      <path d="M339.45,798.1L339.45,798.1c0.6,64.7,53.1,116.9,117.9,116.9c64.8,0,117.4-52.2,117.9-116.9l0,0v-13.7h-235.8V798.1z"></path>
    </g>
  </svg>
);
export const HomeIcon2 = ({ className }) => (
  ...
  >
    <g id="home-anm">
      <path strokeLinejoin="round" strokeLinecap="round" d="M70.5,80.1h40.7" />
      <path d="M35,64v80" />
    ...
    <path
      strokeLinejoin="round"
      d="M145.1,117.6v33.1c0,1.5-1.2,2.8-2.8,2.8h-28.4c-1.5,0-2.8-1.2-2.8-2.8V126
         c0-11.3-9.2-20.5-20.5-20.5c-11.3,0-20.5,9.2-20.5,20.5v27.5h16h-50.5c-1.5,0-2.8-1.2-2.8-2.8v-34.2"
    />
  </svg>
);
...
export const StrategyIcon = ({ className }) => (
  ...
  >
    <g id="strategy-anm">
      <path
        d="M84.1,50.4L72,64.7c-2,2.4-5.2,3.5-8.3,3l-40.1-6.8c-3.2-0.6-5.8,2.4-4.8,5.5L42,
           127.9c1.2,3.6,4.6,6.1,8.4,6.1h81.6c3.9,0,7.3-2.6,8.5-6.3l21.5-61.4c0.9-3-1.7-6-4.9-5.4
           l-38.3,6.7c-3,0.6-6.2-0.5-8.2-2.8L97.4,50.2C93.8,46.3,87.6,46.3,84.1,50.4z"
      />
    </g>
    <path strokeLinecap="round" d="M38.8,153.5h105.5" />
    <path strokeLinecap="round" d="M66.8,112.5h49.5" />
    <path
      id="strategy-cir1"
      strokeWidth="0"
      fill="currentColor"
      d="M32.4,37.5c0,5.8-4.7,10.5-10.5,10.5S11.4,43.3,11.4,37.5S16.1,27,
         21.9,27S32.4,31.7,32.4,37.5z"
    />
    <path
      id="strategy-cir2"
      strokeWidth="0"
      fill="currentColor"
      d="M102.3,23.5c0,5.8-4.7,10.5-10.5,10.5S81.4,29.3,81.4,23.5S86,13,
         91.8,13S102.3,17.7,102.3,23.5z"
    />
    <path
      id="strategy-cir3"
      strokeWidth="0"
      fill="currentColor"
      d="M169.6,37.5c0,5.8-4.7,10.5-10.5,10.5s-10.5-4.7-10.5-10.5S153.3,
         27,159.1,27S169.6,31.7,169.6,37.5z"
    />
  </svg>
);

export const PeriodIcon = ({ className }) => (
  <svg
    className={`${className} icon`}
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 179.1 145"
  >
    ...
    <g id="period-anm">
      ...
      <path
        strokeLinecap="round"
        d="M149.4,153.3H30.6 M75.5,90.7l-23.1,21.2c-1.6,1.4-2.4,3.4-2.4,
           5.6v35.9h78.1V113"
      />
      <g id="period-line">
        <path strokeLinecap="round" d="M50,62.5l40,44.2" />
        <path strokeLinecap="round" d="M128.1,111.7L95.2,73.4" />
      </g>
    </g>
  </svg>
);
...
export const SecurityIcon = ({ className }) => (
  ...
  >
    <path
      strokeLinecap="round"
      d="M94,139c-4.8,1.3-8.8,1.7-11.4,1.8c0,0-18.3,1.1-36.9-11.6c-1.9-1.3-4.7-3.2-7.8-6.2
         c-1.7-1.6-2.9-2.9-3.4-3.6c0,0-3.6-4.2-6.1-8.6c-4.6-8.4-5.4-18.9-5.5-21l0,0V75.5v-39c0-0.7,0.5-1.3,
         1.2-1.5l58-14.2c0.2-0.1,0.5-0.1,0.7,0l57.9,14.7c0.7,0.2,1.1,0.8,1.1,1.5v29.7"
    />
    <path
      id="security-cir"
      strokeLinecap="round"
      d="M158.3,120.7c0,18.3-14.8,33.1-33.1,33.1s-33.1-14.8-33.1-33.1s14.8-33.1,
         33.1-33.1S158.3,102.4,158.3,120.7z"
    />
    <g id="security-strok">
      <path strokeLinecap="round" d="M151.1,104.5l-25,25c-1.3,1.3-3.5,1.3-4.9,0l-9.1-9.1" />
      <path strokeLinecap="round" d="M82.6,43L23.1,62.3" />
      <path strokeLinecap="round" d="M82.6,68.4L23.1,87.6" />
    </g>
  </svg>
);
...
export const SettingsIcon = ({ className }) => (
  ...
  >
    ...
    <g id="settings-anm">
      <path
        strokeLinejoin="round"
        d="M144.7,73.8l-6.2-1c-0.6-1.5-1.2-3-1.9-4.5l3.6-5.1c3.2-4.4,2.7-10.5-1.2-14.3
           l-7.4-7.4c-2.1-2.1-4.9-3.3-7.8-3.3c-2.3,0-4.5,0.7-6.4,2.1l-5.1,3.6c-1.6-0.7-3.2-1.4-4.8-2l-1-6.1
           c-0.9-5.4-5.5-9.3-10.9-9.3H85.1c-5.4,0-10,3.9-10.9,9.2L73.1,42c-1.5,0.6-3,1.2-4.5,1.9l-5-3.6
           c-1.9-1.4-4.1-2.1-6.5-2.1c-3,0-5.8,1.2-7.8,3.3l-7.4,7.4c-3.8,3.8-4.3,9.8-1.2,14.3l3.7,5.2c-0.7,
           1.5-1.3,3-1.8,4.5l-6.1,1c-5.4,0.9-9.3,5.5-9.3,10.9v10.5c0,5.4,3.9,10,9.2,10.9l6.3,
           1.1c0.6,1.5,1.2,3,1.9,4.5l-3.6,5c-3.2,4.4-2.7,10.5,1.2,14.3l7.4,7.4c2.1,2.1,4.9,3.3,7.8,
           3.3c2.3,0,4.5-0.7,6.4-2.1L69,136c1.4,0.6,2.8,1.2,4.2,1.7l1,6.2c0.9,5.4,5.5,9.3,10.9,
           9.3h10.5c5.4,0,10-3.9,10.9-9.2l1-6.2c1.5-0.6,3-1.2,4.5-1.9l5.1,3.6c1.9,1.4,4.1,2.1,6.5,
           2.1c3,0,5.7-1.2,7.8-3.3l7.4-7.4c3.8-3.8,4.3-9.8,1.2-14.3l-3.6-5.1c0.7-1.5,1.3-3,1.9-4.5
           l6.2-1c5.4-0.9,9.3-5.5,9.3-10.9V84.8C153.9,79.3,150.1,74.7,144.7,73.8z"
      />
    </g>
  </svg>
);
...
export const MenuIcon3 = ({ className }) => (
  <svg
    className={className}
    fill="none"
    stroke="currentColor"
...
export const SearchIcon2 = ({ className }) => (
  <svg
    className={className}
    fill="none"
    stroke="currentColor"
...
export const UserIcon2 = ({ className }) => (
  <svg
  className={className}
  fill="currentColor"
  stroke="currentColor"
...
export const ButtonArrowIcon = ({ className }) => (
  <svg
    className={className}
    fill="none"
    stroke="currentColor"
...
export const CollegeIcon = ({ className }) => (
  <svg
    className={className}
    xmlns="http://www.w3.org/2000/svg"
    viewBox="-1 0 19 19"
...
export const ForkAndKnifeIcon = ({ className }) => (
  <svg
    className={className}
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 512 512"
  ...
  >
    <path
      d="M207.103,23.875v109.219c0,7-5.656,12.641-12.625,12.641h-3.375c-6.969,0-12.641-5.641-12.641-12.641V23.375
      ...
      C253.04-7.25,207.103-8.344,207.103,23.875z"
    />
    <path
      d="M385.228,34.75c-11.75,32.953-45.578,110.156-47.719,178.344c-3.313,105.844,61.547,90.188,62.703,159.531
      v138.688h55.078l0.266,0.688c0,0,0-0.281,0-0.688c0-9.266,0-119.625,0-232.203c0-111.359,0-224.797,0-244.359
      C455.556-5.438,403.524-16.531,385.228,34.75z"
    />
  </svg>
);
...
export const VolumeIcon = ({ className }) => (
  <svg
    ...
    strokeWidth="1.008"
  >
    <polygon points="1.75 5.75 1.75 10.25 4.25 10.25 8.25 13.25 8.25 2.75 4.25 5.75"></polygon>
    <path d="m10.75 6.25s1 .5 1 1.75-1 1.75-1 1.75"></path>
  </svg>
);
...
export const MuteIcon = ({ className }) => (
  ...
  >
    <polygon points="1.75 5.75 1.75 10.25 4.25 10.25 8.25 13.25 8.25 2.75 4.25 5.75"></polygon>
    <path d="m14.25 5.75-3.5 4.5m0-4.5 3.5 4.5"></path>
  </svg>
);
...
export const NotificationsIcon = ({ className }) => (
  <svg
    className={className}
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 24 24"
