...
`,ButtonContainer=styled_components__WEBPACK_IMPORTED_MODULE_10__.default.div`
...
`,TextInput4_SubmitButton=styled_components_browser_esm.default.button`
  display: flex;
...
`,ArrowIcon=(0,styled_components_browser_esm.default)(Icons.ArrowRightIcon)`
  width: 20px;
  height: 20px;
  fill: currentColor;
`,textInputs_TextInput4=_ref=>{let{onSubmit,...props}=_ref;return react.createElement(InputWrapper,{gridSpan:props.gridSpan},react.createElement(StyledInput,_extends({},props,{onKeyDown:event=>{"Enter"===event.key&&onSubmit&&onSubmit(event)}})),react.createElement(TextInput4_SubmitButton,{onClick:onSubmit},react.createElement(ArrowIcon,null)))},FormContainer=styled_components_browser_esm.default.div`
  display: grid;
...
//# sourceMappingURL=stories-form-forms-Form-stories.9553a7fa.iframe.bundle.js.map