...
`,ToggleLabel=styled_components_browser_esm.default.label`
  margin-left: 8px;
  font-weight: 500;
`,ToggleInput=styled_components_browser_esm.default.input`
  width: 50px;
  height: 25px;
...
//# sourceMappingURL=stories-form-inputs-toggleSwitch-stories.101700fe.iframe.bundle.js.map