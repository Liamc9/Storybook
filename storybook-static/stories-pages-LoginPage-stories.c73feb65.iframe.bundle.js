...
`,IconWrapper1=styled_components_browser_esm.Ay.div`
  display: flex;
  justify-content: center;
`,LettzIconStyled=(0,styled_components_browser_esm.Ay)(Icons.LettzIcon)`
  width: 50px;
  height: 50px;
...
`,Message=styled_components_browser_esm.Ay.p`
  ...
  text-align: center;
`,Form=styled_components_browser_esm.Ay.form`
  display: flex;
  flex-direction: column;
  gap: 20px;
  margin-bottom: 20px;
`,CheckboxWrapper=styled_components_browser_esm.Ay.label`
  display: flex;
  align-items: center;
  gap: 8px;
  margin-top: 10px;
`,Checkbox=styled_components_browser_esm.Ay.input`
  cursor: pointer;
...
`,RememberMeContainer=styled_components_browser_esm.Ay.div`
  display: flex;
  align-items: center;
  justify-content: end;
  margin-bottom: 10px;
`,ForgotPasswordButton=styled_components_browser_esm.Ay.button`
  background: none;
  border: none;
  color: ${props=>props.themeColor};
  font-size: 1rem;
...
`,Divider=styled_components_browser_esm.Ay.div`
  display: flex;
  align-items: center;
  justify-content: center;
  margin: 20px 0;
...
`,HorizontalLine=styled_components_browser_esm.Ay.hr`
  flex: 1;
  border: none;
...
`,LoginWrapper=styled_components_browser_esm.Ay.div`
  margin-top: 16px;
  text-align: center;
`,LoginLink=styled_components_browser_esm.Ay.button`
  background: none;
  border: none;
  color: ${props=>props.themeColor};
  font-weight: 500;
...
`,OAuthButton=styled_components_browser_esm.Ay.button`
  padding: 12px;
  border: none;
  width: 100%;
  border-radius: 30px;
...
`,IconWrapper=styled_components_browser_esm.Ay.span`
  display: inline-flex;
  align-items: center;
  margin-right: 10px;
