"use strict";(self.webpackChunkstorybook=self.webpackChunkstorybook||[]).push([[3587],{"./src/stories/molecules/search/SearchDrawer.stories.js":(__unused_webpack_module,__webpack_exports__,__webpack_require__)=>{__webpack_require__.r(__webpack_exports__),__webpack_require__.d(__webpack_exports__,{Default:()=>Default,__namedExportsOrder:()=>__namedExportsOrder,default:()=>__WEBPACK_DEFAULT_EXPORT__});var react__WEBPACK_IMPORTED_MODULE_0__=__webpack_require__("./node_modules/react/index.js"),_components_molecules_search_SearchDrawer__WEBPACK_IMPORTED_MODULE_1__=__webpack_require__("./src/components/molecules/search/SearchDrawer.jsx");const __WEBPACK_DEFAULT_EXPORT__={title:"Molecules/Search/SearchDrawer",component:_components_molecules_search_SearchDrawer__WEBPACK_IMPORTED_MODULE_1__.A},trendingItems=["React Hooks","Storybook","JavaScript ES6","Tailwind CSS"],searchResults=[{title:"React Native",description:"A framework for building native apps with React.",thumbnail:"https://example.com/react-native.png"},{title:"Redux",description:"A predictable state container for JavaScript apps.",thumbnail:"https://example.com/redux.png"},{title:"GraphQL",description:"A query language for APIs and a runtime for executing those queries.",thumbnail:null}],Default=()=>react__WEBPACK_IMPORTED_MODULE_0__.createElement(_components_molecules_search_SearchDrawer__WEBPACK_IMPORTED_MODULE_1__.A,{trendingItems,searchResults}),__namedExportsOrder=["Default"];Default.parameters={...Default.parameters,docs:{...Default.parameters?.docs,source:{originalSource:"() => <SearchDrawer trendingItems={trendingItems} searchResults={searchResults} />",...Default.parameters?.docs?.source}}}},"./src/components/molecules/search/SearchDrawer.jsx":(__unused_webpack_module,__webpack_exports__,__webpack_require__)=>{__webpack_require__.d(__webpack_exports__,{A:()=>search_SearchDrawer});var react=__webpack_require__("./node_modules/react/index.js"),styled_components_browser_esm=__webpack_require__("./node_modules/styled-components/dist/styled-components.browser.esm.js"),Icons=__webpack_require__("./src/components/Branding/icons/Icons.jsx");const SearchBarContainer=styled_components_browser_esm.default.div`
  display: flex;
  align-items: center;
  width: 100%;
...
`,Wrapper=styled_components_browser_esm.default.div`
  padding: 16px;
`,search_SearchDrawer=_ref=>{let{trendingItems,query,onQueryChange,searchResults,closeDrawer,onSearchSubmit,renderSearchResult,renderTrendingItem,isOpen}=_ref;const inputRef=(0,react.useRef)(null);(0,react.useEffect)((()=>{isOpen&&inputRef.current&&inputRef.current.focus()}),[isOpen]);const filteredResults=searchResults.filter((result=>result.title.toLowerCase().includes(query.toLowerCase())));return react.createElement(Wrapper,null,react.createElement(SearchDrawer_SearchBarContainer,null,react.createElement(search_SearchBar2,{value:query,onChange:e=>{onQueryChange(e.target.value)},placeholder:"Search for...",onKeyDown:e=>{"Enter"===e.key&&""!==query.trim()&&onSearchSubmit()},inputRef}),react.createElement(CancelButton,{onClick:()=>{onQueryChange(""),closeDrawer()}},"Cancel")),react.createElement("div",null,""===query?react.createElement("div",null,react.createElement("h3",null,"Trending"),trendingItems.map(((item,index)=>renderTrendingItem(item,index)))):react.createElement("div",null,react.createElement("h3",null,"Search Results"),filteredResults.length>0?filteredResults.map(((result,index)=>renderSearchResult(result,index))):react.createElement("p",null,"No results found."))))}}}]);
//# sourceMappingURL=stories-molecules-search-SearchDrawer-stories.5949a70a.iframe.bundle.js.map