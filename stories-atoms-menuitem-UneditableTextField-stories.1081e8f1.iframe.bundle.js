"use strict";(self.webpackChunkstorybook=self.webpackChunkstorybook||[]).push([[2959],{"./src/stories/atoms/menuitem/UneditableTextField.stories.js":(__unused_webpack_module,__webpack_exports__,__webpack_require__)=>{__webpack_require__.r(__webpack_exports__),__webpack_require__.d(__webpack_exports__,{Default:()=>Default,Email:()=>Email,Phone:()=>Phone,__namedExportsOrder:()=>__namedExportsOrder,default:()=>UneditableTextField_stories});var react=__webpack_require__("./node_modules/react/index.js"),Icons=__webpack_require__("./src/components/Branding/icons/Icons.jsx"),styled_components_browser_esm=__webpack_require__("./node_modules/styled-components/dist/styled-components.browser.esm.js");const FieldContainer=styled_components_browser_esm.default.div`
  display: flex;
  align-items: center;
  padding: 16px;
...
`,TextWrapper=styled_components_browser_esm.default.div`
  display: flex;
  flex-direction: column;
`,FieldName=styled_components_browser_esm.default.div`
  font-size: 12px;
  color: #9ca3af; /* Equivalent to text-gray-400 */
`,FieldValue=styled_components_browser_esm.default.div`
  font-size: 16px;
  font-weight: 500;
...
//# sourceMappingURL=stories-atoms-menuitem-UneditableTextField-stories.1081e8f1.iframe.bundle.js.map