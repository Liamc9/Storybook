"use strict";(self.webpackChunkstorybook=self.webpackChunkstorybook||[]).push([[734],{"./src/stories/form/inputs/toggleSwitch.stories.js":(__unused_webpack_module,__webpack_exports__,__webpack_require__)=>{__webpack_require__.r(__webpack_exports__),__webpack_require__.d(__webpack_exports__,{AnimatedToggle:()=>AnimatedToggle,DefaultToggle:()=>DefaultToggle,__namedExportsOrder:()=>__namedExportsOrder,default:()=>toggleSwitch_stories});var react=__webpack_require__("./node_modules/react/index.js"),styled_components_browser_esm=__webpack_require__("./node_modules/styled-components/dist/styled-components.browser.esm.js");function _extends(){return _extends=Object.assign?Object.assign.bind():function(n){for(var e=1;e<arguments.length;e++){var t=arguments[e];for(var r in t)({}).hasOwnProperty.call(t,r)&&(n[r]=t[r])}return n},_extends.apply(null,arguments)}const ToggleWrapper=styled_components_browser_esm.Ay.div`
      grid-column: ${props=>props.gridSpan||"auto"};

  display: flex;
  align-items: center;
  margin-bottom: 16px;
`,ToggleLabel=styled_components_browser_esm.Ay.label`
  margin-left: 8px;
  font-weight: 500;
`,ToggleInput=styled_components_browser_esm.Ay.input`
  width: 50px;
  height: 25px;
...
`,toggleSwitches_ToggleSwitch=_ref=>{let{label,...props}=_ref;return react.createElement(ToggleWrapper,{gridSpan:props.gridSpan},react.createElement(ToggleInput,_extends({type:"checkbox"},props)),react.createElement(ToggleLabel,{htmlFor:props.id},label))};var ToggleSwitch2=__webpack_require__("./src/components/form/inputs/toggleSwitches/ToggleSwitch2.jsx");const toggleSwitch_stories={title:"Form/Inputs/ToggleSwitch",component:toggleSwitches_ToggleSwitch,subcomponents:{ToggleSwitch2:ToggleSwitch2.A},argTypes:{label:{control:"text",description:"Label for the toggle switch",defaultValue:"Default Toggle"},id:{control:"text",description:"Unique ID for the toggle switch",defaultValue:"toggle-default"},checked:{control:"boolean",description:"Toggle switch checked state",defaultValue:!1},disabled:{control:"boolean",description:"Disable the toggle switch",defaultValue:!1}}},DefaultToggle=(args=>react.createElement(toggleSwitches_ToggleSwitch,args)).bind({});DefaultToggle.args={label:"Default Toggle",id:"toggle-default",disabled:!1};const AnimatedToggle=(args=>react.createElement(ToggleSwitch2.A,args)).bind({});AnimatedToggle.args={label:"Animated Toggle",id:"toggle-animated",disabled:!1};const __namedExportsOrder=["DefaultToggle","AnimatedToggle"];DefaultToggle.parameters={...DefaultToggle.parameters,docs:{...DefaultToggle.parameters?.docs,source:{originalSource:"args => {\n  return <ToggleSwitch {...args} />;\n}",...DefaultToggle.parameters?.docs?.source}}},AnimatedToggle.parameters={...AnimatedToggle.parameters,docs:{...AnimatedToggle.parameters?.docs,source:{originalSource:"args => {\n  return <ToggleSwitch2 {...args} />;\n}",...AnimatedToggle.parameters?.docs?.source}}}},"./src/components/form/inputs/toggleSwitches/ToggleSwitch2.jsx":(__unused_webpack_module,__webpack_exports__,__webpack_require__)=>{__webpack_require__.d(__webpack_exports__,{A:()=>__WEBPACK_DEFAULT_EXPORT__});var react__WEBPACK_IMPORTED_MODULE_0__=__webpack_require__("./node_modules/react/index.js");function _extends(){return _extends=Object.assign?Object.assign.bind():function(n){for(var e=1;e<arguments.length;e++){var t=arguments[e];for(var r in t)({}).hasOwnProperty.call(t,r)&&(n[r]=t[r])}return n},_extends.apply(null,arguments)}const StyledWrapper=__webpack_require__("./node_modules/styled-components/dist/styled-components.browser.esm.js").Ay.div`
        grid-column: ${props=>props.gridSpan||"auto"};
...
//# sourceMappingURL=stories-form-inputs-toggleSwitch-stories.de4687c5.iframe.bundle.js.map