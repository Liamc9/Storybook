...
`,Label=styled_components__WEBPACK_IMPORTED_MODULE_1__.default.label`
  margin-bottom: 8px;
  font-weight: 600;
`,ColorInput=styled_components__WEBPACK_IMPORTED_MODULE_1__.default.input`
  width: 50px;
  height: 50px;
  padding: 0;
  border: none;
...
//# sourceMappingURL=1177.053dc5b0.iframe.bundle.js.map