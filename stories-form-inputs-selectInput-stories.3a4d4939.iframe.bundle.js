...
`,selectInputs_SelectInput3=_ref=>{let{label,options,...props}=_ref;return react.createElement(SelectInput3_SelectWrapper,{gridSpan:props.gridSpan},label&&react.createElement(SelectInput3_StyledLabel,{htmlFor:props.id},label),react.createElement(SelectInput3_StyledSelect,props,options&&options.map((option=>react.createElement("option",{key:option.value,value:option.value},option.label)))))};var SelectInput=__webpack_require__("./src/components/form/inputs/selectInputs/SelectInput.jsx");const selectInputs_SelectToTextInput=_ref=>{let{options}=_ref;const[selectedValue,setSelectedValue]=(0,react.useState)(""),[isEditing,setIsEditing]=(0,react.useState)(!1);return react.createElement("div",null,isEditing?react.createElement("input",{type:"text",value:selectedValue,onChange:e=>{setSelectedValue(e.target.value)}}):react.createElement("select",{value:selectedValue,onChange:e=>{setSelectedValue(e.target.value),setIsEditing(!0)}},react.createElement("option",{value:"",disabled:!0},"Select an option"),options.map(((option,index)=>react.createElement("option",{key:index,value:option.value},option.label)))))},selectInput_stories={title:"Form/Inputs/SelectInput",argTypes:{label:{control:"text",description:"Label for the select input",defaultValue:"Choose an option"},id:{control:"text",description:"Unique ID for the select input",defaultValue:"select-input-default"},options:{control:"object",description:"Options for the select input as an array of objects with `value` and `label`",defaultValue:[{value:"",label:"Please select"},{value:"option1",label:"Option 1"},{value:"option2",label:"Option 2"},{value:"option3",label:"Option 3"}]},value:{control:"text",description:"Current selected value",defaultValue:""},onChange:{action:"value-changed"},disabled:{control:"boolean",description:"Disables the select input when true",defaultValue:!1}}},CustomOptionsSelectInput2=args=>react.createElement(selectInputs_SelectInput2,args);CustomOptionsSelectInput2.args={label:"Select Your Favorite Fruit",id:"select-input-fruit",options:[{value:"",label:"Please select"},{value:"apple",label:"Apple"},{value:"banana",label:"Banana"},{value:"cherry",label:"Cherry"}],value:"",disabled:!1};const CustomOptionsSelectInput3=args=>react.createElement(selectInputs_SelectInput3,args);CustomOptionsSelectInput3.args={label:"Select Your Favorite Color",id:"select-input3-color",options:[{value:"",label:"Please select"},{value:"red",label:"Red"},{value:"green",label:"Green"},{value:"blue",label:"Blue"}],value:"",disabled:!1};const DefaultSelectInput=args=>react.createElement(SelectInput.A,args);DefaultSelectInput.args={label:"Choose an option",id:"select-input-default",options:[{value:"",label:"Please select"},{value:"red",label:"Red"},{value:"green",label:"Green"},{value:"blue",label:"Blue"}],value:"",disabled:!1};const DefaultSelectToTextInput=args=>react.createElement(selectInputs_SelectToTextInput,args);DefaultSelectToTextInput.args={label:"Choose an option or enter a custom value",id:"select-to-text-input-default",options:[{value:"",label:"Please select"},{value:"red",label:"Red"},{value:"green",label:"Green"},{value:"blue",label:"Blue"}],value:"",disabled:!1};const __namedExportsOrder=["CustomOptionsSelectInput2","CustomOptionsSelectInput3","DefaultSelectInput","DefaultSelectToTextInput"];CustomOptionsSelectInput2.parameters={...CustomOptionsSelectInput2.parameters,docs:{...CustomOptionsSelectInput2.parameters?.docs,source:{originalSource:"args => <SelectInput2 {...args} />",...CustomOptionsSelectInput2.parameters?.docs?.source}}},CustomOptionsSelectInput3.parameters={...CustomOptionsSelectInput3.parameters,docs:{...CustomOptionsSelectInput3.parameters?.docs,source:{originalSource:"args => <SelectInput3 {...args} />",...CustomOptionsSelectInput3.parameters?.docs?.source}}},DefaultSelectInput.parameters={...DefaultSelectInput.parameters,docs:{...DefaultSelectInput.parameters?.docs,source:{originalSource:"args => <SelectInput {...args} />",...DefaultSelectInput.parameters?.docs?.source}}},DefaultSelectToTextInput.parameters={...DefaultSelectToTextInput.parameters,docs:{...DefaultSelectToTextInput.parameters?.docs,source:{originalSource:"args => <SelectToTextInput {...args} />",...DefaultSelectToTextInput.parameters?.docs?.source}}}},"./src/components/form/inputs/selectInputs/SelectInput.jsx":(__unused_webpack_module,__webpack_exports__,__webpack_require__)=>{__webpack_require__.d(__webpack_exports__,{A:()=>__WEBPACK_DEFAULT_EXPORT__});var react__WEBPACK_IMPORTED_MODULE_0__=__webpack_require__("./node_modules/react/index.js"),styled_components__WEBPACK_IMPORTED_MODULE_2__=__webpack_require__("./node_modules/styled-components/dist/styled-components.browser.esm.js"),_Branding_icons_Icons__WEBPACK_IMPORTED_MODULE_1__=__webpack_require__("./src/components/Branding/icons/Icons.jsx");const SelectContainer=styled_components__WEBPACK_IMPORTED_MODULE_2__.Ay.div`
  position: relative;
...
//# sourceMappingURL=stories-form-inputs-selectInput-stories.3a4d4939.iframe.bundle.js.map